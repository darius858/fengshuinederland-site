      ...
      <div className="mx-0 max-w-6xl">
        ...
        >
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Mijn interesse in energie begon al vroeg. Ik merkte vaak intuïtief
          ...
          <p className="mt-4 text-lg leading-8 text-gray-600">
            Oorspronkelijk ben ik agrarisch geschoold, maar al snel voelde ik dat
            dit niet de richting was die echt bij mij paste. Na een periode van
            zoeken en ontwikkelen kwam ik in aanraking met Feng Shui. Dat voelde
            direct als de juiste plek.
          </p>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <p className="mt-6 leading-8 text-gray-600">
              ...
              Conceptual Feng Shui Professional. Sinds 2020 help ik mensen om hun
              leef- en werkomgeving zo in te richten dat deze meer rust, balans
            ...
            <p className="mt-4 leading-8 text-gray-600">
              Ook in andere situaties heb ik gezien hoeveel invloed een omgeving
              kan hebben — zelfs bij honden met gedragsproblemen.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div>
            <h2 className="text-3xl font-semibold">Feng Shui én Nine Star Ki</h2>
            ...
            <p className="mt-4 leading-8 text-gray-600">
              Door deze inzichten te combineren met de inrichting van een ruimte
              ontstaat er een krachtig geheel: een omgeving die niet alleen goed
              voelt, maar ook beter aansluit op de mensen die erin werken en
              leven.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-[#eee7dd]">
            ...
            <ul className="mt-6 space-y-4 text-gray-700">
              ...
              <li>• Inrichting beïnvloedt gedrag en energie</li>
        ...
        >
          ...
          <p className="mt-6 text-white/80">
            Plan een gratis intake en ontdek wat er mogelijk is voor jouw ruimte,
            werkplek of situatie.
          </p>
