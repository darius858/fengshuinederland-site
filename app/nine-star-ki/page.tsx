        ...
        >
          ...
          <div>
            ...
            <p className="mt-4 leading-8 text-gray-600">
              ...
              natuurlijke cyclus en beïnvloeden hoe energie zich ontwikkelt.
            </p>
          </div>
        </motion.div>
      ...
      <section className="px-6 pb-20 md:pb-24">
        ...
        >
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-[#eee7dd]">
            ...
            <p className="mt-4 leading-7 text-gray-600">
              Ontdek hoe verschillende energieën binnen een team elkaar kunnen
        ...
        >
          ...
          <div>
            ...
            <p className="mt-6 leading-8 text-gray-600">
              ...
              communicatie en werkstijl beter te begrijpen. Waar de één snel en
